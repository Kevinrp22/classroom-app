          ...
          <div class="max-w-[200px] h-100">
            <svg viewBox="0 0 238 134" fill="none" xmlns="http://www.w3.org/2000/svg" class="bqfGyf w-full"
              ...
              <path
                ...
                fill="#5F6368"></path>
              <path d="M141.516 38.3389C143.043 39.0428 146.545 40.2635 148.328 39.5154" stroke="#5F6368"
                    stroke-width="2"
                    stroke-linecap="round"></path>
              <path d="M135.566 39.291C136.151 40.1914 138.081 42.1456 141.131 42.7594" stroke="#5F6368"
                    stroke-width="2"
                    stroke-linecap="round"></path>
              ...
              <path
                ...
                fill="#DADCE0"></path>
              <path d="M119.279 33.8346C118.111 35.2699 115.428 40.2128 121.11 43.8439" stroke="#5F6368"
                    stroke-width="2"
                    stroke-linecap="round"></path>
              <path d="M98 36.957H115V40.957L98 40.557V36.957Z" fill="#DADCE0"></path>
              <path d="M99.1969 41.8728C102.843 43.7476 111.606 45.8632 117.496 39.3267" stroke="#5F6368"
                    stroke-width="2"
                    stroke-linecap="round"></path>
            </svg>
          </div>
