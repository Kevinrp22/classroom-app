<x-app-layout>
  <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    ...
    @empty
      <div class="flex justify-center items-center flex-col py-6 text-center">
        <div class="max-w-[200px] h-100">
          <svg viewBox="0 0 238 134" fill="none" xmlns="http://www.w3.org/2000/svg" class="bqfGyf w-full"
               aria-hidden="true">
            <path
            ...
            <path
              ...
              fill="#5F6368"></path>
            <path d="M101.789 5.96962L95.4866 5.6473L98.927 11.0948" stroke="#5F6368" stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"></path>
            <path
              d="M107 103.3L183 103.957V88.5222C183 57.8497 160.068 32.957 131.783 32.957L107.859 42.0865L107 103.3Z"
              fill="#DADCE0"></path>
            <path d="M97 102.957H120V93.9578H106.187C101.098 93.893 97 97.9718 97 102.957Z" fill="#DADCE0"></path>
            <path
            ...
            <path
              ...
              stroke-linejoin="round"></path>
            <path d="M118.04 99.4629C116.18 99.8045 114.688 102.179 114.505 103.087" stroke="#5F6368" stroke-width="2"
                  stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M104 98.957C102.084 99.619 101 102.087 101 102.957" stroke="#5F6368" stroke-width="2"
                  stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
            <path
            ...
            <path
              ...
              fill="#5F6368"></path>
            <path d="M141.516 38.3389C143.043 39.0428 146.545 40.2635 148.328 39.5154" stroke="#5F6368" stroke-width="2"
                  stroke-linecap="round"></path>
            <path d="M135.566 39.291C136.151 40.1914 138.081 42.1456 141.131 42.7594" stroke="#5F6368" stroke-width="2"
                  stroke-linecap="round"></path>
            <path d="M41 102H70V88H41C45.1938 92.1674 45.1938 97.8326 41 102Z" fill="#5F6368"></path>
            <path
            ...
            <path
              ...
              fill="#5F6368"></path>
            <path d="M112 7.95703L114 13.957" stroke="#5F6368" stroke-width="2" stroke-linecap="round"></path>
            <path d="M137 6.95703L138 12.957" stroke="#5F6368" stroke-width="2" stroke-linecap="round"></path>
            <path
            ...
            <path
              ...
              fill="white" stroke="#5F6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            <path
              ...
              fill="#DADCE0"></path>
            <path d="M119.279 33.8346C118.111 35.2699 115.428 40.2128 121.11 43.8439" stroke="#5F6368" stroke-width="2"
                  stroke-linecap="round"></path>
            <path d="M98 36.957H115V40.957L98 40.557V36.957Z" fill="#DADCE0"></path>
            <path d="M99.1969 41.8728C102.843 43.7476 111.606 45.8632 117.496 39.3267" stroke="#5F6368" stroke-width="2"
                  stroke-linecap="round"></path>
          </svg>
        </div>
